...
Run an adversarial Antigravity review through the companion runtime.
Position it as a challenge review that questions the chosen implementation, design choices, tradeoffs, and assumptions — not just defects.
...
- `/antigravity:adversarial-review` supports `--scope`, `--base`, and `--focus`.
